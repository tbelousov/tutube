 ...
 * <p>
 * Слушает {@link ActionSavedEvent} и запускает асинхронный анализ:
 * <ul>
...
@Slf4j
public class ActionEventHandler implements EventHandler<ActionSavedEvent> {
    ...
    @Override
    public Class<ActionSavedEvent> eventType() {
        return ActionSavedEvent.class;
    }

    /**
     * Обрабатывает сохранённое действие.
     * <p>
     ...
     */
    @Override
    public void handle(ActionSavedEvent event) {
